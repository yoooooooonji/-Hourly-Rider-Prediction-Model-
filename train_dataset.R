...
table(train_data$outlier) # 132,332/ 4553
455300/(132332+4553) #3.32
...
dplyr::select (day_of_reg, pick_rgn2_nm, rider_cnt, order_cnt, datetime, hour_reg, reg_date, temp_c,
rain_c, snow_c, is_rain, month, week, is_holiday,is_holiday2)
...
# 결측치 채우기 
combined_data <- combined_data  %>% 
mutate(rider_cnt_w_1 = ifelse(is.na(rider_cnt_w_1), rider_cnt, rider_cnt_w_1),
